defmodule SymphonyElixir.CLI do
  ...
  @switches [{@acknowledgement_switch, :boolean}, logs_root: :string, port: :integer, host: :string]
  ...
  defp usage_message do
    "Usage: symphony [--logs-root <path>] [--port <port>] [--host <host>] [path-to-WORKFLOW.md]"
  end
